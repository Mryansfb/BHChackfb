...
name = raw_input ("\033[91mUsername?(Namalu!) : ")
...
if name == (""):
     ...
     print '\x1b[1;92mnama lu kan gak pake angka asyu'
     os.sys.exit()

password = getpass.getpass("\x1b[1;92mMasukan Password Nya cuk! : ")
...
if password == ("mryans"):
     ...
     time.sleep(0.5)
     print 'Inagt' + name + ' tolong Gunain tools dengan baik'
     time.sleep(0.5)
     print 'Thanks To: Black Hat Cyber'
     time.sleep(0.5)
     print 'mastah ' + name + ' add Wa aku ya kalo tools rusak <0895613141995>'
     time.sleep(0.5)
     print 'nick: Mryans.|94Ns'
     time.sleep(3.0)
else:
     print ("lihat password di link ini bit.ly/PasswordScriptFB")
     os.sys.exit()
